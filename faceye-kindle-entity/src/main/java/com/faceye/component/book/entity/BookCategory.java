...
/**
 * 模块:电子书->book->BookCategory<br>
 * 说明:<br>
 * 实体:分类->com.faceye.component.book.entity.BookCategory Mongo 对像<br>
 * mongo数据集:book_bookCategory<br>
 * @author haipenge <br>
...
@Document(collection="faceye_11_book_bookcategory")
