	...
	<div class="header">
		<h3>
			<c:choose>
				...
				<c:otherwise>
					<fmt:message key="book.author.edit"></fmt:message>
				</c:otherwise>
			</c:choose>
		</h3>
	</div>
	<div class="content">
	<form:form action="/book/author/save" method="post" role="form" cssClass="form-horizontal" commandName="author">
			<form:hidden path="id"/>
			<fieldset>
				<div class="form-group">
					<label class="col-md-2 control-label" for="name"> <spring:message code="book.author.profile"/>
					</label>
					<div class="col-md-6">
				...
				<div class="form-group">
					<label class="col-md-2 control-label" for="name"> <spring:message code="book.author.name"/>
					</label>
					<div class="col-md-6">
